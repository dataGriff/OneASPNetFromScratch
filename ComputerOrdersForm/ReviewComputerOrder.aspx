<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReviewComputerOrder.aspx.cs" Inherits="ComputerOrdersForm.ReviewComputerOrder" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="Label7" runat="server" Text="Rush Orderr: "></asp:Label>
